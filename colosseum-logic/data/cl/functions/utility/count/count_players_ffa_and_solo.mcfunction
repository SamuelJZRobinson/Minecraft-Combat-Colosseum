...
# End Game Abruptly
execute if score isSolo Settings matches 0 if score ffaAliveCount PlayerCount matches ..1 run schedule function cl:states/stages/increment_state 1t replace
