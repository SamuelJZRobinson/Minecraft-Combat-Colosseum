...
# Standard Point
execute if score teamOwner GameKoth matches 1.. run function cl:states/stages/9_main_round/gamemodes/koth/multi/set_score_teams
...
execute if score bonusTime GameKoth >= CAPTURE_DELAY GameKoth run function cl:states/stages/9_main_round/gamemodes/koth/multi/bonus_step_success