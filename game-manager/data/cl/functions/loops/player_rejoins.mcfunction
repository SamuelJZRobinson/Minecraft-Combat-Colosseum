...
# Teleport
  # Lobby
  execute if score isGameStarted GameStatus matches 0 run function cl:utility/teleports/tp_lobby
  ...
  # Centre
  execute if score isGameStarted GameStatus matches 1 run function cl:utility/teleports/tp_centre
