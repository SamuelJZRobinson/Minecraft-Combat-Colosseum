...
# Grace Time
execute if score graceSeconds Settings matches 1 run scoreboard players set seconds Timer 30
execute if score graceSeconds Settings matches 2 run scoreboard players set minutes Timer 1
execute if score graceSeconds Settings matches 3 run scoreboard players set minutes Timer 2

# Proceed
schedule function cl:utility/timer/tick 1t replace