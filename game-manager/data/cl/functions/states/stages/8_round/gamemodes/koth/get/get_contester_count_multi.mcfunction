...
execute if entity @a[team=Blue,distance=..5] run scoreboard players add contestersCount Koth 1
execute if entity @a[team=Red,distance=..5] run scoreboard players add contestersCount Koth 1
execute if entity @a[team=Green,distance=..5] run scoreboard players add contestersCount Koth 1
execute if entity @a[team=Yellow,distance=..5] run scoreboard players add contestersCount Koth 1
