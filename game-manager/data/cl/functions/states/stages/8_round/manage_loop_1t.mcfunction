# Gamemodes
  # Tick Events
    # Static KOTH
    execute if score gamemode Settings matches 3 run function cl:states/stages/8_round/gamemodes/koth/tick
    # Moving KOTH
    execute if score gamemode Settings matches 4 run function cl:states/stages/8_round/gamemodes/koth/tick
