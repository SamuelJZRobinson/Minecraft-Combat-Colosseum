# Give Gear
  ...
  # Moving KOTH
  execute if score gamemode Settings matches 4 run function cl:states/stages/8_round/gamemodes/koth/give_koth_kit
  # Spleef
  execute if score gamemode Settings matches 5 run function cl:states/stages/8_round/gamemodes/spleef/give_spleef_kit
  # Target Practice
  execute if score gamemode Settings matches 6 run function cl:states/stages/8_round/gamemodes/target_practice/manage_gear
