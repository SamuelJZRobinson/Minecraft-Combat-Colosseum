...
# Inventory
  ...
  item replace entity @s inventory.5 with diamond_pickaxe[can_break={predicates:[{blocks:"#cl:block_placement"}]},enchantments={levels:{"minecraft:efficiency":3,"minecraft:unbreaking":3}}] 1
  # Row 2
...
# Hotbar
item replace entity @s hotbar.0 with diamond_sword[can_break={predicates:[{blocks:"#cl:block_placement"}]},enchantments={levels:{"minecraft:sharpness":4}}] 1
item replace entity @s hotbar.1 with diamond_axe[can_break={predicates:[{blocks:"#cl:block_placement"}]},enchantments={levels:{"minecraft:sharpness":1}}] 1
