...
execute if score lobbyAliveCount AssignTeams < playersRequired AssignTeams run function gc:utility/exceptions/raise_warning {message:""}
execute if score lobbyAliveCount AssignTeams < playersRequired AssignTeams run function gc:states/3_start_request/tests/show_player_count_gap