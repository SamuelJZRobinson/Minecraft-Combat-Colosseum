...
# Loop
execute if entity @e[type=player,team=Lobby] run function gc:states/5_assign_teams/set_teams_teams
execute if entity @e[type=player,team=!Lobby] run schedule function gc:states/inc_state 1t replace