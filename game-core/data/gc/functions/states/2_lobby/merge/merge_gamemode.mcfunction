...
# Gamemodes
  # Basic PVP
  execute if score gamemode Settings matches 1 run function gc:states/2_lobby/merge/merge_gamemode_basic_pvp
  # Special PVP
  execute if score gamemode Settings matches 2 run function gc:states/2_lobby/merge/merge_gamemode_special_pvp
  # Static KOTH
  execute if score gamemode Settings matches 3 run function gc:states/2_lobby/merge/merge_gamemode_static_koth
  # Moving Koth
  execute if score gamemode Settings matches 4 run function gc:states/2_lobby/merge/merge_gamemode_moving_koth
  # Spleef
  execute if score gamemode Settings matches 5 run function gc:states/2_lobby/merge/merge_gamemode_spleef
  # Target Practice
  execute if score gamemode Settings matches 6 run function gc:states/2_lobby/merge/merge_gamemode_target_practice
